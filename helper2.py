...
def draw_clusters(biased_dataset, predictions, cmap='viridis'):
    ...
    plt.scatter(clustered['avg_horror_rating'], clustered['avg_thriller_rating'], c=clustered['group'], s=20, cmap=cmap)
    plt.show()
...
def draw_clusters_3d(biased_dataset_3, predictions):
    ...
    for g in clustered.group.unique():
        ...
        for index, point in clustered[clustered.group == g].iterrows():
            if point['avg_fantasy_rating'].astype(float) > 3:
                size = 50
            else:
                size = 15
            plt.scatter(point['avg_horror_rating'],
...
def bias_genre_rating_dataset(genre_ratings, score_limit_1, score_limit_2):
    biased_dataset = genre_ratings[((genre_ratings['avg_horror_rating'] < score_limit_1 - 0.2) & (
                genre_ratings['avg_thriller_rating'] > score_limit_2)) | (
                                               (genre_ratings['avg_thriller_rating'] < score_limit_1) & (
                                                   genre_ratings['avg_horror_rating'] > score_limit_2))]
